...
class Window:
    ...
    def __init__(self, myGame):
        ...
        self.update_tiles()
        self.surfacebob = pygame.Surface((self.window.infoObject.current_w-200, self.window.infoObject.current_h-200))
        self.surfacetile = pygame.Surface((self.window.infoObject.current_w-200, self.window.infoObject.current_h-200))
    ...
    def update_tiles(self):
        ...
        for y in range(gridSizeY):
            for x in range(gridSizeX):
                ...
                self.surfacetile.blit(pygame.transform.scale_by(self.GTile.image,self.zoom), self.isoCoordTable[(x,y)])
    ...
    def update_bobs(self):
        ...
        for key in self.Game.gridBob:
            for bob in self.Game.gridBob[key]:
                ...
                self.surfacebob.blit(pygame.transform.scale_by(self.GBob.image,self.zoom), (x,y))
    ...
    def update_food(self):
        ...
        for key in self.Game.gridFood:
            ...
            self.surfacebob.blit(pygame.transform.scale_by(self.GFood.image,self.zoom), (x,y))
