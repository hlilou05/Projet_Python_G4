...
import os
assets = {
    "arriere_plan" : pygame.image.load(os.path.abspath("arrière_plan.jfif")),
    "bob" : pygame.image.load(os.path.abspath("bob.png")),
    "bob.blue" : pygame.image.load(os.path.abspath("bob.blue.png")),
    "bob.rouge" : pygame.image.load(os.path.abspath("bob.rouge.png")),
    "food" : pygame.image.load(os.path.abspath("nourriture.png")),
    "fond_ecran" : pygame.image.load(os.path.abspath("Photo.png")),
    "tile" : pygame.image.load(os.path.abspath("Tile32x32.png")),
}
...
class Bob:
    ...
    def escape(self):
        ...
        for i in range(-velocity + a, velocity + 1 + a):
            ...
            for j in range(-velocity  + b, velocity  + 1 + b):
...
class View:
    ...
    def __init__(self, myGame):
        ...
        self.isoCoordTable = {}
        # Menu
        self.music_song = pygame.mixer.Sound("music_pygame.mp3")
    ...
    def display_tiles(self):
        ...
        self.afficher_texte("Pause", self.screen.get_width() - 125, 75)
        ...
        for y in range(-self.value // 2, self.value // 2):
            for x in range(-self.value // 2, self.value // 2):
                ...
                self.screen.blit(pygame.transform.scale(new_tile.image, (int(32 * self.zoom), int(32 * self.zoom))),(self.iso_coord(new_tile.rect.x, new_tile.rect.y)[0] + self.offsetx * TILE_SIZE,
    ...
    def affiche_pause_menu(self):
        ...
        while self.pause_menu_active:
            ...
            self.afficher_texte("Options", self.screen.get_width() // 2, 325)
            pygame.draw.ellipse(self.screen, marron, (300, 400, 200, 50))
            self.afficher_texte("Quit to Menu", self.screen.get_width() // 2, 425)
    ...
    def affiche_formulaire(self, variables):
        ...
        self.affiche_deuxieme_page()  # Appeler la méthode pour afficher 
