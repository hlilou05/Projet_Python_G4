...
class Window:
    ...
    def __init__(self,myGame):
        ...
        self.screen = pygame.display.set_mode((self.infoObject.current_w-200,self.infoObject.current_h-200))
        self.running = True
        self.zoom = 1
        self.offsetx = 0
        self.offsety = 0
    ...
    def run(self):
        self.continuous_display_thread()  # Ajout de l'appel à la fonction pour mettre à jour l'affichage
        while self.running:
