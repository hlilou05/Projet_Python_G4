...
foodQty = 20 #quantité d'items Food générés par jours
...
class GraphicBob():
    def __init__(self):
        self.image = pygame.image.load("annexes/bob.png")
        self.image_blue = pygame.image.load("annexes/bob.blue.png")
        self.image_red = pygame.image.load("annexes/bob.rouge.png")
